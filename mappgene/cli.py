...
def parse_args(args):
    ...
    parser.add_argument('--primers_bp', default=400, choices={'400', '1200', 'v4', 'v4.1', 'combo_3_4.1', 'v5.3.2', 'zibra_KU501215.1', 'zibra_KU955593.1', 'zibra_KX087101.3', 'zibra_KJ776791.2', 'm1000_KU955593.1', 'm1000_KU501215.1', 400, 1200},
