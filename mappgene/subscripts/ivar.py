...
'''
    ...
    r1_fastp = replace_extension(read1, '_R1_fastp_temp.fastq')
    ...
    run(f'fastp -i {read1} -I {read2} -o {r1_fastp} -O {r2_fastp} -D --trim_front1 {trim_front_tail} --trim_tail1 {trim_front_tail} -l 25 -w {threads} -h {Subject_dir}'.fastp.html' 2>dev/null}', params) 
